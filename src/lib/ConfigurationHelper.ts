...
export function getDefaultChannelMarkers(markerNames: string[]): Record<ChannelName, string | null> {
...
export function getDefaultChannelDomains(): Record<ChannelName, [number, number]> {
    return {
