...
ipcMain.on('plotWindow-set-plot-downsample-ratio', (event: Electron.Event, value: number): void => {
    if (mainWindow != null) mainWindow.webContents.send('set-set-plot-downsample-ratio', value)
})
